...
//    codeViewer.javaFileName = fileName;
    ...
    $(document).ready(function () {
        ...
        var commitURLIndex = (document.URL.substr(0, document.URL.lastIndexOf("/"))).substr(document.URL.substr(0, document.URL.lastIndexOf("/")).lastIndexOf("/") + 1);
        var sourceCodeURL = "/code/git/" + commitURLIndex + "/" + codeURLIndex;
